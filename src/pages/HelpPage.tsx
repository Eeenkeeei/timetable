...
export default class HelpPage extends React.Component {
    ...
    public render() {
        ...
        const questions: question[] = [
            ...
            {
                question: 'Почему при нажатии на кнопку "Назад" в браузере перебрасывает на сломанную страницу?',
                ask: 'Автор - человек бедный, и еще не купил нормальный адрес. Будет исправлено в ближайшие дни. А пока - просто не нажимай эту кнопку и пользуйся меню на сайте :З'
            },
            {
